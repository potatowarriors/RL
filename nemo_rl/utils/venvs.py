...
def make_actor_runtime_env(actor_class_fqn: str) -> dict:
    ...
    They use the VLLM tier by default or the current interpreter when
    ``NEMO_RL_PY_EXECUTABLES_SYSTEM=1``. Also used by the SGLang router and
    SGLang generation engines (SGLANG tier).
    """
